...
share_of_resources()
print('Доли ресурсов в полезном энергопотреблении посчитаны')
...
def group_by():
    ...
    group_list = [nan, nan, nan, nan, nan, nan, nan, nan, nan, nan, nan, nan, 4.0, 2.0, 5.0, 5.0, 6.0, 3.0, 3.0, 6.0,
                  ...
                  3.0, nan, 4.0, 3.0, 5.0, 4.0, nan, 6.0, 5.0, 3.0, 4.0, 1.0, 6.0, nan, nan, 2.0, 4.0, 4.0, 3.0, 4.0]
